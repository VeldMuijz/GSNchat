...
app.controller('accountController', ['$scope', '$location', '$timeout', 'authService', function ($scope, $location, $timeout, authService) {
    if (authService.authentication.isAuth && authService.authentication.role === "Admin") {
        ...
        console.log("Is user authenticated? " + authService.authentication.isAuth + " User role: " + authService.authentication.role);
        $location.path('/home');
    }
